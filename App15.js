...
<head>
  ...
  <link href="Rapid/img/favicon.png" rel="icon"/>
  <link href="Rapid/img/apple-touch-icon.png" rel="apple-touch-icon"/>


  <link href="https://fonts.googleapis.com/css?family=Open+Sans0:300,300i,400,400i,500,600,700,700i|Montserrat:300,400,500,600,700" rel="stylesheet"/>

 
  <link href="Rapid/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet"/>
  ...
  <header id="header">
    ...
    <div className="container">
      ...
      <div className="logo float-left">
        ...
        <a href="#header" className="scrollto"><img src="Rapid/img/logo.png" alt="" className="img-fluid"/></a> 
      </div>
    ...
    <div className="container d-flex h-100">
      <div className="row justify-content-center align-self-center">
        ...
        <div className="col-md-6 intro-img order-md-last order-first">
          <img src="Rapid/img/intro-img.svg" alt="" className="img-fluid"/>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-lg-5 col-md-6">
            <div className="about-img">
              <img src="Rapid/img/about-img.jpg" alt=""/>
            </div>
          </div>
    ...
    <section id="services" className="section-bg">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s">
            <div className="box">
              <div className="icon" style={{background: "#ecebff"}}><i className="ion-ios-clock-outline" style={{color: "#8660fe"}}></i></div>
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <div className="why-us-img">
              <img src="Rapid/img/why-us.jpg" alt="" className="img-fluid"/>
            </div>
          </div>
      ...
      <div className="container">
        ...
        <div className="row feature-item">
          <div className="col-lg-6 wow fadeInUp">
            <img src="Rapid/img/features-1.svg" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row feature-item mt-5 pt-5">
          <div className="col-lg-6 wow fadeInUp order-1 order-lg-2">
            <img src="Rapid/img/features-2.svg" className="img-fluid" alt=""/>
          </div>
        ...
        <div className="row portfolio-container">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/app1.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">App 1</a></h4>
                <p>App</p>
                <div>
                  <a href="Rapid/img/portfolio/app1.jpg" data-lightbox="portfolio" data-title="App 1" className="link-preview" title="Preview"><i className="ion ion-eye"></i></a>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/web3.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">Web 3</a></h4>
                <p>Web</p>
                <div>
                  <a href="Rapid/img/portfolio/web3.jpg" className="link-preview" data-lightbox="portfolio" data-title="Web 3" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/app2.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">App 2</a></h4>
                <p>App</p>
                <div>
                  <a href="Rapid/img/portfolio/app2.jpg" className="link-preview" data-lightbox="portfolio" data-title="App 2" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-card">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/card2.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">Card 2</a></h4>
                <p>Card</p>
                <div>
                  <a href="Rapid/img/portfolio/card2.jpg" className="link-preview" data-lightbox="portfolio" data-title="Card 2" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/web2.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">Web 2</a></h4>
                <p>Web</p>
                <div>
                  <a href="Rapid/img/portfolio/web2.jpg" className="link-preview" data-lightbox="portfolio" data-title="Web 2" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/app3.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">App 3</a></h4>
                <p>App</p>
                <div>
                  <a href="Rapid/img/portfolio/app3.jpg" className="link-preview" data-lightbox="portfolio" data-title="App 3" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-card">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/card1.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">Card 1</a></h4>
                <p>Card</p>
                <div>
                  <a href="Rapid/img/portfolio/card1.jpg" className="link-preview" data-lightbox="portfolio" data-title="Card 1" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-card" data-wow-delay="0.1s">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/card3.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">Card 3</a></h4>
                <p>Card</p>
                <div>
                  <a href="Rapid/img/portfolio/card3.jpg" className="link-preview" data-lightbox="portfolio" data-title="Card 3" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.2s">
            <div className="portfolio-wrap">
              <img src="Rapid/img/portfolio/web1.jpg" className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4><a href="#">Web 1</a></h4>
                <p>Web</p>
                <div>
                  <a href="Rapid/img/portfolio/web1.jpg" className="link-preview" data-lightbox="portfolio" data-title="Web 1" title="Preview"><i className="ion ion-eye"></i></a>
                  <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-8">
            ...
            <div className="owl-carousel testimonials-carousel wow fadeInUp">
              ...
              <div className="testimonial-item">
                <img src="Rapid/img/testimonial-1.jpg" className="testimonial-img" alt=""/>
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
                <p>
              ...
              <div className="testimonial-item">
                <img src="Rapid/img/testimonial-2.jpg" className="testimonial-img" alt=""/>
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <p>
              ...
              <div className="testimonial-item">
                <img src="Rapid/img/testimonial-3.jpg" className="testimonial-img" alt=""/>
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <p>
              ...
              <div className="testimonial-item">
                <img src="Rapid/img/testimonial-4.jpg" className="testimonial-img" alt=""/>
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <p>
        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6 wow fadeInUp">
            <div className="member">
              <img src="Rapid/img/team-1.jpg" className="img-fluid" alt=""/>
          ...
          <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div className="member">
              <img src="Rapid/img/team-2.jpg" className="img-fluid" alt=""/>
              <div className="member-info">
                <div className="member-info-content">
                  <h4>Sarah Jhonson</h4>
          ...
          <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div className="member">
              <img src="Rapid/img/team-3.jpg" className="img-fluid" alt=""/>
              <div className="member-info">
                <div className="member-info-content">
          ...
          <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div className="member">
              <img src="Rapid/img/team-4.jpg" className="img-fluid" alt=""/>
              <div className="member-info">
                <div className="member-info-content">
                  <h4>Amanda Jepson</h4>
    ...
    <section id="clients" className="wow fadeInUp">
      <div className="container">
        ...
        <div className="owl-carousel clients-carousel">
          <img src="Rapid/img/clients/client-1.png" alt=""/>
          <img src="Rapid/img/clients/client-2.png" alt=""/>
          <img src="Rapid/img/clients/client-3.png" alt=""/>
          <img src="Rapid/img/clients/client-4.png" alt=""/>
          <img src="Rapid/img/clients/client-5.png" alt=""/>
          <img src="Rapid/img/clients/client-6.png" alt=""/>
          <img src="Rapid/img/clients/client-7.png" alt=""/>
          <img src="Rapid/img/clients/client-8.png" alt=""/>
        </div>
...
0
  ...
  <script src="Rapid/lib/jquery/jquery.min.js"></script>
  <script src="Rapid/lib/jquery/jquery-migrate.min.js"></script>
  <script src="Rapid/lib/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="Rapid/lib/easing/easing.min.js"></script>
  <script src="Rapid/lib/mobile-nav/mobile-nav.js"></script>
  <script src="Rapid/lib/wow/wow.min.js"></script>
  <script src="Rapid/lib/waypoints/waypoints.min.js"></script>
  <script src="Rapid/lib/counterup/counterup.min.js"></script>
  <script src="Rapid/lib/owlcarousel/owl.carousel.min.js"></script>
  <script src="Rapid/lib/isotope/isotope.pkgd.min.js"></script>
  <script src="Rapid/lib/lightbox/js/lightbox.min.js"></script>

  <script src="Rapid/contactform/contactform.js"></script>


  <script src="Rapid/js/main.js"></script>
